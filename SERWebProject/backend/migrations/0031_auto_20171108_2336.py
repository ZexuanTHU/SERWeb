# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-11-08 15:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2017, 11, 8, 15, 36, 42, 436300, tzinfo=utc), verbose_name='比赛时间'),
        ),
        migrations.AddField(
            model_name='project',
            name='match_venue',
        ...
        migrations.AddField(
            model_name='projectregisterrelationship',
            name='student_id',
            field=models.CharField(default='2014000000', max_length=10, verbose_name='学号'),
        ),
        migrations.AddField(
            model_name='projectregisterrelationship',
            name='user_info',
        ...
        migrations.AlterField(
            model_name='project',
            name='ddl_date',
            field=models.DateTimeField(default=datetime.datetime(2017, 11, 8, 15, 36, 42, 436300, tzinfo=utc), verbose_name='报名截止日期'),
        ),
        migrations.AlterField(
            model_name='project',
            name='group_project',
        ...
        migrations.AlterField(
            model_name='project',
            name='pub_date',
            field=models.DateTimeField(default=datetime.datetime(2017, 11, 8, 15, 36, 42, 436300, tzinfo=utc), verbose_name='发布时间'),
        ),
        migrations.AlterField(
            model_name='projectregisterrelationship',
        ...
        migrations.AlterField(
            model_name='userinfo',
            name='birth_date',
            field=models.DateField(default=datetime.datetime(2017, 11, 8, 15, 36, 42, 435799, tzinfo=utc), verbose_name='出生日期'),
        ),
        migrations.AlterField(
            model_name='userinfo',
            name='clothes_size',
